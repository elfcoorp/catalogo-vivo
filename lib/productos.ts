...
export const PRODUCTOS: Producto[] = [
  ...
  },
  {
    ...
    fichaTecnica: [
      ...
      { etiqueta: "Tina de lavado", valor: "48\" de ancho x 66 ft de largo total · Giro de 180°, 2 sistemas arreador, tubería para recirculación de agua con bomba, motobomba centrífuga, sección inclinada al final, chasis en acero inoxidable" },
      { etiqueta: "Elevador de rodillos (10 ft)", valor: "36\" de ancho x 10 ft de largo · Tubo PVC de 2\" Ø cédula 40, 2 chutes de rezaga, sistema de espreas de 2 líneas, chasis y transmisión en acero inoxidable" },
      { etiqueta: "Transportador de banda modular", valor: "36\" de ancho x 26 ft de largo total, a 180° · Banda plástica modular, chasis y transmisión en acero inoxidable" },
      { etiqueta: "Cepilladora de lavado (adicional)", valor: "36\" de ancho x 4 ft de largo · 10 cepillos de cerda sintética, sistema de lavado por aspersión, charola de escurrimiento, sistema arreador, chasis y transmisión en acero inoxidable" },
      { etiqueta: "Mesa de rodillos (secado)", valor: "36\" de ancho x 30 ft de largo · Tubo PVC de 2\" Ø cédula 40, 2 ventiladores centrífugos, 7 ventiladores axiales, divisor central, chasis en acero inoxidable y transmisión en acero negro" },
      { etiqueta: "Elevador de rodillos (13 ft)", valor: "36\" de ancho x 13 ft de largo · Tubo PVC de 2\" Ø cédula 40, sistema de giro, divisor al centro en inoxidable, chasis en acero inoxidable y transmisión en acero negro" },
