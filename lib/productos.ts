...
export const PRODUCTOS: Producto[] = [
  ...
  },
  {
    ...
    caracteristicas: ["Marca CIU · 4 líneas x 12 salidas @ 27\"", "Semi-nueva · Solo 1 temporada de uso", "Incluye caseta de control"],
    ...
    fichaTecnica: [
      ...
      { etiqueta: "Bandas de bajada (segunda calidad)", valor: "2 bandas con canjilones · Contacto con la fruta en acero inoxidable, banda de PVC, canjilones de PVC o Nylamide. Bajan la segunda calidad de la mesa de selección hacia la segunda selección. No incluye la banda larga donde se selecciona la segunda calidad a mano" },
      ...
      { etiqueta: "Bandas sanitarias", valor: "Superior de 16\" x 3.00 m · Transportadora de 12\" x 5.00 m con canjilones · Con desviador de fruta de 0.60 m x 3.00 m · De 24\" x 3.50 m con canjilones de 2\" x 1¼\"" },
