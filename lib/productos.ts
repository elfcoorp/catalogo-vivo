...
export const PRODUCTOS: Producto[] = [
  ...
  },
  {
    ...
    beneficio:
      "Se desmontó DISPARANDO SOLENOIDES: cámaras, computadora, tarjetas y salidas, toda la cadena trabajando. Y el técnico que la instaló y le ha dado servicio todos estos años sigue disponible para volverla a montar.",
    caracteristicas: [
      "Marca MAF · 2 líneas x 22 salidas",
      "Se quitó disparando solenoides · un año guardada",
      "Va con visión, servidor y tarjetas MAF RODA",
    ],
    frutas: ["tomate"],
    clasificaPor: ["peso"],
    estatus: "disponible",
    ...
    resumenTarjeta: "Se quitó disparando solenoides · con su técnico",
    nombreCorto: "Clasificadora MAF · 2 líneas x 22 salidas",
    zona: "Noroeste de México",
    precio: "$420,000 MXN + IVA",
    facilidades:
    ...
    fichaTecnica: [
      ...
      { etiqueta: "Qué hay que cambiarle", valor: "LAS COPITAS son el único punto difícil: ya no se fabrican de línea, pero el técnico que la conoce las consigue. La cadena hay que revisarla — puede que todavía dé otra temporada" },
      ...
      { etiqueta: "El cerebro, y va incluido", valor: "Servidor HP ProLiant ML350 con procesador Intel Xeon · monitor · cabezal de DOS CÁMARAS · tarjetas de control MAF RODA (CPS 05, V3.0) · tarjetas de entradas y salidas de 24 V. Todo se va con la máquina" },
      { etiqueta: "La prueba de que servía", valor: "Cuando se desmontó estaba DISPARANDO LOS SOLENOIDES sin problema. Eso quiere decir que toda la cadena trabajaba: las cámaras leían, la computadora decidía, las tarjetas mandaban la señal y las salidas respondían" },
      { etiqueta: "Las refacciones — lo que SÍ se consigue", valor: "Las tarjetas MAF RODA se siguen consiguiendo y son las mismas, no han cambiado. Los solenoides también se consiguen. MAF Roda sigue existiendo como fabricante" },
  ...
  },
  {
    ...
    caracteristicas: ["Marca CIU · 4 líneas x 12 salidas @ 27\"", "Se usó solo una temporada", "Incluye caseta de control"],
    ...
    fichaTecnica: [
      ...
      { etiqueta: "Separación entre salidas", valor: "27 pulgadas" },
      { etiqueta: "Descarga", valor: "Hacia ambos lados, en espejo" },
      { etiqueta: "Básculas", valor: "24 piezas, marca CAS, con celda de carga de 100 kg y display sujeto al chasis · Cubierta de acero inoxidable" },
      { etiqueta: "Singulador de bandas en V", valor: "4 líneas x 3.05 m, alimenta la clasificadora · Motor trifásico de 2 HP con variador de velocidad" },
      { etiqueta: "Andamios de la mesa de selección", valor: "0.60 m de ancho x 3.00 m de largo, con barandales y escaleras" },
      { etiqueta: "Banda superior de la mesa", valor: "16\" x 3.00 m, con canjilones · Corre la fruta a lo largo de la mesa de selección manual · Incluye bajada lateral" },
      { etiqueta: "Bandas que bajan la segunda calidad", valor: "Dos, las dos con canjilones: una de 12\" x 5.00 m y otra de 24\" x 3.50 m (canjilones de 2\" x 1¼\" de base) · Bajan de la mesa de selección hacia la segunda selección" },
      { etiqueta: "Banda de proceso", valor: "0.60 m x 3.00 m, con desviador de fruta · Manda la primera calidad al singulador" },
      { etiqueta: "Materiales de las bandas", valor: "Banda de PVC, canjilones de PVC o Nylamide · Contacto con la fruta en acero inoxidable · Motores trifásicos con variador de velocidad" },
      { etiqueta: "No incluye", valor: "La banda larga donde se selecciona a mano la segunda calidad" },
      { etiqueta: "Tolvas de recepción", valor: "1.20 m de ancho, salida a 27\", tapizadas con dulona de 6 mm · Con puerta para llenado de cajas" },
      { etiqueta: "Transportadores", valor: "De rodillos motorizados de 16\" x 9.00 m con barandal · De rodillos de gravedad de 16\", rodillos galvanizados de 1⅞\" · De bola de 16\" x 9.00 m para caja de cartón vacía" },
      { etiqueta: "Bancos de llenado", valor: "8 piezas de 0.30 m x 0.45 m, con patas para ajuste de altura" },
      { etiqueta: "Caseta de control", valor: "2.20 m x 2.20 m, con escalera · No incluye cristales" },
      { etiqueta: "Corriente", valor: "Motores trifásicos de 220-440 V, con variador de velocidad" },
      { etiqueta: "Materiales de la estructura", valor: "Acero al carbón con pintura electrostática · Todas las partes en contacto con la fruta, en acero inoxidable" },
    ],
    garantia: "Antes de que te la lleves, la encendemos frente a ti en la bodega: prendemos y probamos cada función para que la veas trabajar. Se vende como está — puede faltarle un detalle menor (un tornillo, una lámina, o como vaya pintada), nunca algo que afecte su funcionamiento. Tú decides viéndola encendida. No se entrega instalada, salvo que contrates la instalación aparte. Trabajamos con contrato firmado: se cubre un anticipo antes de iniciar la carga, y el resto se liquida antes de que la máquina salga del empaque.",
  },
  {
