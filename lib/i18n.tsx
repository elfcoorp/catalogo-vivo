...
export const TEXTOS = {
  es: {
    ...
    tabNuevas: "Líneas nuevas a pedido",
    tabPersonalizadas: "Personalizadas",
    nuevasTitulo: "Armamos tu línea completa con fabricantes aliados",
    nuevasSubtitulo: "Entrega en semanas, no en meses.",
    nuevasTexto: "Cuéntanos qué necesitas y lo revisamos contigo. No se trata de usadas de inventario — son líneas nuevas, armadas para tu empaque.",
    nuevasBoton: "Cuéntanos qué necesitas",
  ...
  en: {
    ...
    tabNuevas: "New lines to order",
    tabPersonalizadas: "Custom",
    nuevasTitulo: "We build your complete line with partner manufacturers",
    nuevasSubtitulo: "Delivery in weeks, not months.",
    nuevasTexto: "Tell us what you need and we'll go over it with you. This isn't used inventory — these are new lines, built for your packing house.",
    nuevasBoton: "Tell us what you need",
  ...
  pt: {
    ...
    tabNuevas: "Linhas novas sob encomenda",
    tabPersonalizadas: "Personalizadas",
    nuevasTitulo: "Montamos sua linha completa com fabricantes parceiros",
    nuevasSubtitulo: "Entrega em semanas, não em meses.",
    nuevasTexto: "Conte-nos o que você precisa e vamos analisar juntos. Não é estoque usado — são linhas novas, feitas para sua embaladora.",
    nuevasBoton: "Conte-nos o que você precisa",
